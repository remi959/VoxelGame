...
namespace Assets.Scripts.Resources
{
    public class ResourceFragment : MonoBehaviour
    {
        ...
        /// </summary>
        public void Setup(EResourceType type, int resourceValue, Vector3 position, Transform parent = null)
        {
            resourceType = type;
            value = resourceValue;
            ...
            // Check if pooling is available
            usePooling = FragmentPool.Instance != null;
        }

        /// <summary>
        /// Set the visual key for this fragment (used for pooling).
        /// </summary>
        public void SetVisualKey(VisualKey key)
        {
            visualKey = key;
        }
        ...
        private void SetupPhysics()
        {
            ...
            if (col == null)
            {
                ...
                // Try to size based on renderer
                var renderer = GetComponent<MeshRenderer>();
                if (renderer != null)
                {
                    boxCol.center = renderer.bounds.center - transform.position;
        ...
        private void Update()
        {
            ...
            if (horizontalDist > maxDistance || launchTimer >= settleTime)
            {
                StopMovement();
            }
        }
        ...
        /// <summary>
        /// Immediately return to pool or destroy (for cleanup scenarios).
        /// </summary>
        ...
        {
            if (usePooling && FragmentPool.Instance != null)
            {
                FragmentPool.Instance.Return(this);
            }
            else
            {
                Destroy(gameObject);
        ...
        /// <summary>
        /// Reset the fragment for reuse from pool.
        /// </summary>
        public void ResetForPool()
        {
            ...
            // Clean up physics components (will be re-added on Setup)
            if (rb != null)
            {
                Destroy(rb);
                rb = null;
